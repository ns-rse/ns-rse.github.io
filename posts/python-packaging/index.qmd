...
author: "nshephard"
date: "2023-03-25"
categories: [quarto, python, packaging, setuptools, github actions, pypi]
image: https://live.staticflickr.com/65535/52595884731_fb5c7d576e_k.jpg
from: markdown+emoji
toc: true
toc-depth: 4
toc-location: right
...
`pyproject.toml` which works with Python \>= 3.7, but you may wish to consider other packages such as [Poetry](#poetry)
or [PDM](#PDM) which offer some advantages but with additional frameworks to learn.

A few examples of Python packages that I have packaged are listed below, most have also been released to
[PyPI](https://pypi.org/).

-   [tcx2gpx](https://pypi.org/project/tcx2gpx/) (personal)
...
and gradually replaced by `setup.cfg`. The new method on the block though is `pyproject.toml` which, with a little
tweaking and judicious choice of packages can handle everything.
...
[setuptools~scm~](https://github.com/pypa/setuptools_scm/) is a simple to use extension to setuptools that dynamically
...
[setuptools-scm](https://github.com/pypa/setuptools_scm) is simpler to setup and use than

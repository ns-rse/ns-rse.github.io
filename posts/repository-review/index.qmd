...
date: "2023-11-17"
categories: [pre-commit, packaging, scientific python, python]
image: https://live.staticflickr.com/65535/53258300629_64b0ee5703_k.jpg
from: markdown+emoji
toc: true
toc-depth: 4
toc-location: right
...
I've written before about [Python Packaging](https://ns-rse.github.io/#category=packaging) and
[pre-commit](https://ns-rse.github.io/#category=pre-commit) which I'm a big fan of. Today I discovered a really useful
...
![[Elektro](https://www.flickr.com/photos/slackline/53258300629/)](https://live.staticflickr.com/65535/53258300629_64b0ee5703_k.jpg)
...
There are a few [pre-commit](https://ns-rse.github.io/#category=pre-commit) hooks that I wasn't aware of and will be
...
Now I just need to find time to apply [MyPy](https://mypy.readthedocs.io/en/stable/).

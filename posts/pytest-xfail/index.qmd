...
To exclude the test with `id` of `five divided by two` under Python 3.10 we would do the following (again note the need
to `import sys` and its use in the `cond` positional argument).

...
There are a *lot* of hooks out there to be used with [pre-commit](https://pre-commit.com) and incorporated into your
...
more, there is even [gitlint](https://github.com/jorisroovers/gitlint) which lints your commit messages! Checkout the long list of available [hooks](https://pre-commit.com/hooks) and try some out.

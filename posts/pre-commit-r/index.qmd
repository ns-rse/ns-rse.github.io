...
This post is aimed at getting you up and running with making an the
[precommit](https://cran.r-project.org/web//packages/precommit/vignettes/precommit.html) Package. This shouldn't be
confused with [pre-commit](https://ns-rse.github.io/pre-commit) which is a Python Package. The R package consists of a
number of R specific hooks that

...
frameworks for working with virtual environments such as [`venv`](),
[`virtualenv`](https://pypi.python.org/pypi/virtualenv) and  [Conda](). This post introduces and shows some of the
features of [virtualenvwrapper](https://virtualenvwrapper.readthedocs.io/en/latest/).
...
Pull Request. `virtualenvwrapper` can help here as it has the `mktmpenv`

...
The manual covers [conflict](https://jj-vcs.github.io/jj/latest/conflicts/) resolution and its worth reading that. That
I encountered merge conflicts isn't entirely unexpected I had created `.gitignore` both locally and on the remote so

...
commit can be successfully made. Long term linting your code is beneficial (see [Linting - What is all the fluff
about?](https://ns-rse.github.io/posts/linting/)).

Initially this can be jarring, but it saves you, and those who you are asking to review your code in your as yet to be
created pull request, time and effort as it ensures your code meets the required style and is a little bit cleaner

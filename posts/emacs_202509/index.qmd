...
date: "2025-09-05"
categories: [emacs, undo, regex, pre-commit]
...
I'm a big fan of [pre-commit][pre-commit] (see [previous posts][pre-commit-previous]) and already use the
[lisp-format][lisp-format] hook on my configuration files. Recently I clocked there was a new linter in the form of
[pre-commit-elisp][pre-commit-elisp] which I've added to the hooks I use on my configuration repository. Configuration
is simple by adding the following to `.pre-commit-config.yaml`.
...
[pre-commit-elisp]: https://github.com/eschulte/lisp-format
[pre-commit-previous]: https://blog.nshephard.dev/#category=pre-commit

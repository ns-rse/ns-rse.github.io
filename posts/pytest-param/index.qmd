...
![[Minerals by Me](https://www.flickr.com/photos/slackline/53258274023/in/datetaken/)](https://live.staticflickr.com/65535/53258274023_f628d3291a_k.jpg)
...
In order to make our tests suite robust we should test more scenarios and edge cases, in particular making sure we
...
We can combine tests that pass and fail (in the above example a `ZeroDivisionError`) via parameterisation and
whilst Pytest works and allows this some consider this to be bad practice as whilst tests can and should be
parameterised it is better to keep tests focused and on-topic and write a separate test for different outcomes such as
raising exceptions.
...
It can be useful to parameterise fixtures themselves so that they too testsa number of different states and this saves
